...
try
    ...
    for trialIndex = 1:length(prefs.fullFactorialDesign)
        ...
        elseif nItems == 1
            Screen('FillRect', window.onScreen, colorsOfTest', position);
        end
        ...
        while ~any(buttons) || everMovedFromCenter == false
            ...
            guess_box = [1050 800 1120 870];
            Screen('FillRect', window.onScreen, [250 250 250], guess_box'); %%%%%%%%%%%%%%%%%%%%%
