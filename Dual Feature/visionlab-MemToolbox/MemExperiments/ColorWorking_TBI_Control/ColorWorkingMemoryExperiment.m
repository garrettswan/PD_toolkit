...
for block = 1:2
    ...
    try
        ...
        if block == 1
            filename = sprintf('%s%d%s',datadir,subject_num,'_p');
        else
...
%%%%%%%%%% BELOW HERE, YOU CAN EDIT THE DIRECTIONS. THIS MAY NEED TO BE
%%%%%%%%%% ADJUSTED DEPENDING ON THE SCREEN SIZE. 
...
%%%%%%%% THIS IS WHERE YOU CAN ADJUST THE NUMBER OF TRIALS. THE FIRST BLOCK
%%%%%%%% CORRESPONDS TO THE PRACTICE TRIALS. THE SECOND IS FOR THE
%%%%%%%% EXPERIMENTAL BLOCK. THESE VALUES ARE PER CONDITION, SO IT WILL BE
%%%%%%%% DOUBLED. 
